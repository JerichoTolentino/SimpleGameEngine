...
//creates a new matrix with all elements set to 0
Mat4::Mat4()
{
...
void Mat4::inverse()
{
	...
	if (determinant == 0)
	{
		MessageHandler::printMessage("ERROR: Inverse matrix does not exist!\n");
		return;
	}
...
//sets this matrix to be the sum of this matrix & the other matrix
Mat4& Mat4::operator+=(const Mat4 &other)
{
	for (int i = 0; i < 16; i++)
...
//sets this matrix to be the difference of this matrix & the other matrix
Mat4& Mat4::operator-=(const Mat4 &other)
{
	for (int i = 0; i < 16; i++)
		this->elements[i] -= other.elements[i];
